...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ru: {
            ...
            aboutAdvantages4: '💰 Зарплата от 50 000 грн + бонусы без потолка',
            ...
            advantage1Text: 'Зарплата от 50 000 грн, еженедельные бонусы и премии без потолка. Всё официально и без задержек.',
        ...
        ua: {
            ...
            aboutAdvantages4: '💰 Зарплата від 50 000 грн + бонуси без стелі',
            ...
            advantage1Text: 'Зарплата від 50 000 грн, щотижневі бонуси та премії без стелі. Все офіційно та без затримок.',
